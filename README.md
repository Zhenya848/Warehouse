...
Приложение создано для безопасного хранения ваших товаров на складах разных геолокаций и объемов. Каждый товар имеет свой тип и размеры. Товары на складах хранятся в специальных контейнерах. Каждый контейнер содержит только один товар (например, контейнер под морковь, контейнер под лопаты и т.п.). Контейнеры можно перемещать между складами, но не стоит забывать, что каждый склад имеет свои размеры под контейнеры. Нужно внимательно следить за этим!

• Архитектура

Архитектуру рисовал в excallidraw: 

![Снимок экрана 2025-05-05 154519l](https://github.com/user-attachments/assets/f004d05b-d18f-4064-821c-fb5841ab8592)
